            ...
            <Navbar/>
                ...
                <div className={styles.aboutCenter}>
                    ...
                    <article className={styles.aboutInfo}>
                        ...
                        <p>I'm a full-stack software enginner with a background in <a href="https://steinhardt.nyu.edu/programs/international-education" target="_blank" rel="noopener noreferrer" style={style.color}>International Education</a>. After completing the immersive Software programs for women at <a href="https://www.gracehopper.com/" target="_blank" rel="noopener noreferrer" style={style.color}>Grace Hopper Program</a> in April 2020. I joined an incredible software team at <a href="https://mesh-systems.com/" target="_blank" rel="noopener noreferrer" style={style.color}>Mesh System</a> as an Associate Software Engineer. Mesh System is an Internet of Thing innovator that helps the <a href="https://fortune.com/fortune500/" target="_blank" rel="noopener noreferrer" style={style.color}>Fortune 500s companies</a> achieve digital transformation.</p>
                        <p>I commit to being a lifelong learner so I can continue to grow as a developer. I also hope to be a good role model and mentor to other female software enginners to empower women in the tech field.</p>
