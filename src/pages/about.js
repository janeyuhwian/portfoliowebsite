            ...
            <Navbar/>
                ...
                <div className={styles.aboutCenter}>
                    ...
                    <article className={styles.aboutInfo}>
                        ...
                        <p>I was born in Korea, raised in Kentucky, and moved to NYC 4 years ago to pursue my master's degree in International Education at <a href="https://steinhardt.nyu.edu/programs/international-education" target="_blank" style={style.color}>NYU</a>. After I graduated, I worked at a non-profit International Student Exchange program to help deliver meaningful intercultural experiences for students around the world.</p>
                        <p>While I worked as an International Educator, I was facinated by the tech field and saw the power of technology, which allowed us to connect and work with people around the country. So I taught myself Javascipt and completed one of the most well-known Software Engineer program for women at <a href="https://www.gracehopper.com/" target="_blank" style={style.color}>Grace Hopper Program.</a></p>
