            ...
            <Navbar/>
                ...
                <div className={styles.aboutCenter}>
                    ...
                    <article className={styles.aboutInfo}>
                        ...
                        <p>While I worked as an International Educator, I was fascinated by the tech field and saw the power of technology, which allowed us to connect and work with people around the country. So I taught myself Javascipt and completed one of the most well-known Software Engineer program for women at <a href="https://www.gracehopper.com/" target="_blank" rel="noopener noreferrer" style={style.color}>Grace Hopper Program.</a></p>
